...
-- ============================================================================
--
-- IMPORTANTE: O SIGMA atualmente possui apenas um campo 'telefone' na Pessoa
-- Este script vai consolidar múltiplos telefones em um único campo
-- Formato: "(DDD) NUMERO [RAMAL] [TIPO]"
--
-- Autor: Claude Code
-- Data: 2025-01-10
-- ============================================================================
