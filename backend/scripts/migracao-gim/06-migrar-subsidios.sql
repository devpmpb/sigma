...
-- - situacao no GIM: ENTREGUE (7588), CANCELADO (3320), PENDENTE (262)
-- - Status no SIGMA: aprovado, cancelado, pendente
--
-- Autor: Claude Code
-- Data: 2025-01-10
-- ============================================================================
...
/*
EXECUTAR NO WINDOWS (ajuste o caminho se necessário):
*/
...
BEGIN
    ...
    -- Se não existir, usar programa padrão baseado no enquadramento

    -- Mapear códigos do GIM para IDs do SIGMA
    -- cod_programa 1, 2, 3 são os mais comuns conforme análise
