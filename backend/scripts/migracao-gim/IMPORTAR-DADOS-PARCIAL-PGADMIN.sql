-- ============================================================================
-- SCRIPT DE IMPORTAÇÃO PARCIAL - PARA PGADMIN
-- ============================================================================
--
...
-- ============================================================================
-- IMPORTANTE: No pgAdmin, você precisa usar o menu Import
-- Ou executar via COPY (versão SQL padrão)

-- Para Pessoa.csv
COPY staging_gim.pessoa_csv
FROM 'C:\Users\marce\Downloads\Pessoa.csv'
WITH (FORMAT csv, DELIMITER ';', HEADER true, ENCODING 'UTF8');

-- Para PropriedadeRural.csv
COPY staging_gim.propriedade_csv
FROM 'C:\Users\marce\Downloads\PropriedadeRural.csv'
WITH (FORMAT csv, DELIMITER ';', HEADER true, ENCODING 'UTF8');

-- Para Endereco.csv
COPY staging_gim.endereco_csv
FROM 'C:\Users\marce\Downloads\Endereco.csv'
WITH (FORMAT csv, DELIMITER ';', HEADER true, ENCODING 'UTF8');

-- Ver quantos registros foram importados
SELECT 'Pessoas importadas' as tabela, COUNT(*)::text as quantidade FROM staging_gim.pessoa_csv
UNION ALL
SELECT 'Propriedades importadas', COUNT(*)::text FROM staging_gim.propriedade_csv
UNION ALL
SELECT 'Endereços importados', COUNT(*)::text FROM staging_gim.endereco_csv;
...
-- ============================================================================
-- QUERIES DE VALIDAÇÃO (Execute separadamente depois)
-- ============================================================================
